...
Motor leftF(15, E_MOTOR_GEARSET_36, true, E_MOTOR_ENCODER_COUNTS);
Motor leftB(14, E_MOTOR_GEARSET_36, true, E_MOTOR_ENCODER_COUNTS);
Motor rightF(10, E_MOTOR_GEARSET_36, false, E_MOTOR_ENCODER_COUNTS);
Motor rightB(17, E_MOTOR_GEARSET_36, false, E_MOTOR_ENCODER_COUNTS);
